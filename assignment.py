...
#solution-sample_list = [11, 45, 8, 23, 14, 12, 78, 45, 89]
print("Original list ", sample_list)
...
#solution-sample_list = [11, 45, 8, 11, 23, 45, 23, 45, 89]
print("Original list ", sample_list)
...
# Result is  {(6, 36), (8, 64), (4, 16), (5, 25), (3, 9), (7, 49), (2, 4)}
 ...
 #solution-first_list = [2, 3, 4, 5, 6, 7, 8]
...
#solution-first_set = {23, 42, 65, 57, 78, 83, 29}
second_set = {57, 83, 29, 67, 73, 43, 48}
...
#solution-roll_number = [47, 64, 69, 37, 76, 83, 95, 97]
sample_dict = {'Jhon': 47, 'Emma': 69, 'Kelly': 76, 'Jason': 97}
...
# min: 41
# max: 99
#solution-sample_list = [87, 52, 44, 53, 54, 87, 52, 53]
...
#solution-keys = ['Ten', 'Twenty', 'Thirty']
values = [10, 20, 30]
